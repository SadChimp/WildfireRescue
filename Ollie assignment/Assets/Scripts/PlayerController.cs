...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //axeChopSound = GetComponent<AudioSource>();
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.A) && inputEnabled == true)
        {
            if (isUsingEquipment == false)
            {
                ...
                //If raytrace hits object tagged "EnvironmentObject" or "OuterBounds" do the following
                if (hit.collider.gameObject.CompareTag("EnvironmentObject") || hit.collider.gameObject.CompareTag("OuterBounds"))
                {
                    Debug.Log("Blocked path");
                }

                //If raytrace hits object tagged "GroundTile" or "Animal" do the following
                else if (hit.collider.gameObject.CompareTag("GroundTile") || hit.collider.gameObject.CompareTag("Animal"))
                {
    ...
    {     
        ...
        if (other.gameObject.CompareTag("Animal"))
        {
            ...
            Debug.Log(numAnimalsRescued + " animals rescued");
